...
function DatosReserva() {
  ...
  const { detallesPelicula, cantidad, hora, fecha, total } = location.state;
  ...
  return (
    <body className='bg-[#071429] font-poppins'>
        ...
        <div className='mt-10 text-center m-5 bg-gray-800 rounded-lg p-4'>
            <p className='text-[#9b9792] '>Nombre de la película: <span className='text-white'>{detallesPelicula.titulo}</span></p><br />
